...
static const double ddfs_cutoff_x = 0.1;
...
static float get_similarity（float similarity){
...
//transnum_buchang(onedata,mvalue,&endnum,read_len,seed_len,BC)实际调用函数
{
    int eit=0,temp;
    int i,j,start,num;
